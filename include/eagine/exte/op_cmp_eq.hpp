/**
 *  @file eagine/exte/op_cmp_eq.hpp
 *
...
#ifndef EAGINE_EXTE_OP_CMP_EQ_1308281038_HPP
#define EAGINE_EXTE_OP_CMP_EQ_1308281038_HPP
...
template <int A>
using cmp_eq_tag = operator_tag<meta::string<'=','='>, A>;
