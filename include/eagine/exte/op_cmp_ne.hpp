/**
 *  @file eagine/exte/op_cmp_ne.hpp
 *
...
#ifndef EAGINE_EXTE_OP_CMP_NE_1308281038_HPP
#define EAGINE_EXTE_OP_CMP_NE_1308281038_HPP
...
template <int A>
using cmp_ne_tag = operator_tag<meta::string<'!','='>, A>;
