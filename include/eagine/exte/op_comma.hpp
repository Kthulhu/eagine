...
#ifndef EAGINE_EXTE_OP_COMMA_1308281038_HPP
#define EAGINE_EXTE_OP_COMMA_1308281038_HPP
...
template <int A>
using comma_tag = operator_tag<meta::string<','>,A>;
