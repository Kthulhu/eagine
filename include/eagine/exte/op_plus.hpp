...
#ifndef EAGINE_EXTE_OP_PLUS_1308281038_HPP
#define EAGINE_EXTE_OP_PLUS_1308281038_HPP
...
template <int A>
using plus_tag = operator_tag<meta::string<'+'>, A>;
