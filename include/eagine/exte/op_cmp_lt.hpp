/**
 *  @file eagine/exte/op_cmp_lt.hpp
 *
...
#ifndef EAGINE_EXTE_OP_CMP_LT_1308281038_HPP
#define EAGINE_EXTE_OP_CMP_LT_1308281038_HPP
...
template <int A>
using cmp_lt_tag = operator_tag<meta::string<'<'>, A>;
