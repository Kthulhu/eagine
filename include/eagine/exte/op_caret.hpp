...
#ifndef EAGINE_EXTE_OP_CARET_1308281038_HPP
#define EAGINE_EXTE_OP_CARET_1308281038_HPP
...
template <int A>
using caret_tag = operator_tag<meta::string<'^'>, A>;
