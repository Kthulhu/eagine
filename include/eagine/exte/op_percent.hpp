/**
 *  @file eagine/exte/op_percent.hpp
 *
...
#ifndef EAGINE_EXTE_OP_PERCENT_1308281038_HPP
#define EAGINE_EXTE_OP_PERCENT_1308281038_HPP
...
template <int A>
using percent_tag = operator_tag<meta::string<'%'>, A>;
