/**
 *  @file eagine/exte/op_lshift.hpp
 *
...
#ifndef EAGINE_EXTE_OP_LSHIFT_1308281038_HPP
#define EAGINE_EXTE_OP_LSHIFT_1308281038_HPP
...
template <int A>
using lshift_tag = operator_tag<meta::string<'<','<'>, A>;
